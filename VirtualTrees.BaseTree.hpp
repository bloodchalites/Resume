...
private:
	...
	Virtualtrees::Types::PVirtualNode __fastcall FindInPositionCache(Virtualtrees::Types::PVirtualNode Node, TDimension &CurrentPos)/* overload */;
	Virtualtrees::Types::PVirtualNode __fastcall FindInPositionCache(TDimension Position, TDimension &CurrentPos)/* overload */;
	...
	TDimension __fastcall GetNodeHeight(Virtualtrees::Types::PVirtualNode Node);
	...
	void __fastcall SetNodeHeight(Virtualtrees::Types::PVirtualNode Node, TDimension Value);
...
protected:
	...
	void __fastcall AdjustTotalHeight(Virtualtrees::Types::PVirtualNode Node, TDimension Value, bool relative = false);
	...
	virtual System::Types::TSize __fastcall GetImageSize(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TVTImageKind Kind = (Virtualtrees::Types::TVTImageKind)(0x0), TColumnIndex Column = (Virtualtrees::Types::TColumnIndex)(0x0), bool IncludePadding = true);
	...
	virtual TBaseVirtualTree* __fastcall GetTreeFromDataObject(const Virtualtrees::Types::TVTDragDataObject DataObject);
	...
	__property TDimension RangeY = {read=FRangeY, nodefault};
...
public:
	...
	Virtualtrees::Types::PVirtualNode __fastcall IterateSubtree(Virtualtrees::Types::PVirtualNode Node, _di_TVTGetNodeProc Callback, void * Data, Virtualtrees::Types::TVirtualNodeStates Filter = Virtualtrees::Types::TVirtualNodeStates() , bool DoInit = false, bool ChildNodesOnly = false);
	...
	__property TDimension NodeHeight[Virtualtrees::Types::PVirtualNode Node] = {read=GetNodeHeight, write=SetNodeHeight};
